...
def display_explanation(input_df, session, aws_bucket):
    ...
    preprocessing_pipeline = Pipeline(steps=best_pipeline.steps[0:2])                         #if i update steps to say 4 steps... change to [0,3]
    input_df_transformed = preprocessing_pipeline.transform(input_df) 
    feature_names = best_pipeline[0:2].get_feature_names_out()                                   #and in this line too
