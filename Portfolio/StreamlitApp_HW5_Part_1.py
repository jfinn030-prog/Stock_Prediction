...
MODEL_INFO = {
        ...
        "keys": ["DVN_CR_Cum","FANG_CR_Cum"],         #EDIT HERE   from inference 99 and 101
        "inputs": [{"name": k, "type": "number", "min": -100.0, "max": 100.0, "default": 0.0, "step": 10.0} for k in ["DVN_CR_Cum","FANG_CR_Cum"]] 
}
