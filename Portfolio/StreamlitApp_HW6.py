...
MODEL_INFO = {
        ...
        "keys": ['ADBE','AMZN','WMT','sentiment_lex'],   #SHOULD MATCH WHAT YOU HAVE IN NOTEBOOK
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ['ADBE','AMZN','WMT','sentiment_lex']]
}
